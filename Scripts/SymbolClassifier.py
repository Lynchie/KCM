...
class Song():
    ...
    def ProcessSong(self):
        ...
        self.Accidentals = len(self.sharps) + len(self.flats) + len(self.naturals) - (self.NoClefs * abs(self.Key))


        #-- Notes Per Bar --
        
        self.NotesPerBar = self.notes / (self.barLines + 1)

    def PrintData(self):
        print("Key: "+str(self.Key))
        print("Accidentals: "+str(self.Accidentals))
        print("Notes Per Bar: "+str(self.NotesPerBar))
